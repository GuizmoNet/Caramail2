...
foreach($decode_user as $k=>$v) {
    if (preg_match_all("/^([0-9]{1,2}) ([hHmM])/", $v['realname'])) { // pour les hommes
    echo '<a href="#" data-toggle="tooltip" title="'.$v['realname'].'" style="color:#00ACEE;font-weight:bold;">' . $v['nickname'] . '</a><br>';
    echo '<td>'."\r\n"; 
    } else { }
}
}
