...
/* Modal centering (CGU + Mentions légales) */
(function() {
	function centerModal(modalId) {
		$(modalId)
			.addClass('cgu-centered')
			.css({
				position: 'fixed',
				left: '50%',
				top: '50%',
	...
	function scheduleCenter(modalId) {
		setTimeout(function() { centerModal(modalId); }, 0);
		setTimeout(function() { centerModal(modalId); }, 120);
		setTimeout(function() { centerModal(modalId); }, 260);
	}
	$(document).on('click', '[data-reveal-id="cguModal"]', function() {
		scheduleCenter('#cguModal');
	});
	$(document).on('click', '[data-reveal-id="mentionsModal"]', function() {
		scheduleCenter('#mentionsModal');
	});
	$(document).on('opened open.fndtn.reveal', '#cguModal', function() {
		centerModal('#cguModal');
	});
	$(document).on('opened open.fndtn.reveal', '#mentionsModal', function() {
		centerModal('#mentionsModal');
	});
})();
