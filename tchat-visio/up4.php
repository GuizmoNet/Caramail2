        <p class="lead">Chaque jour <strong>des milliers</strong> de visiteurs se retrouvent sur le tchat gratuit - <strong>Rejoignez-nous dès aujourd'hui !</strong></p>
      </div>
...
$femme = file_get_contents($_SERVER["DOCUMENT_ROOT"]."/count-femme.txt");
$homme = file_get_contents($_SERVER["DOCUMENT_ROOT"]."/count-homme.txt");
$inconnu = file_get_contents($_SERVER["DOCUMENT_ROOT"]."/count-inconnu.txt");
echo "
...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <div class="row">
      <div class="twelve columns">
        ...
        <p class="lead"><strong>Chat Caramail</strong> vous propose un <strong>site de rencontres gratuit</strong> avec un <strong>Tchat webcam</strong>, <br>vous n'avez pas besoin de vous inscrire pour y accéder.
      </div>
