<?php include("up.php"); ?>
<title>Tchat Provence-Alpes-Côte-d'Azur - Rencontre gratuite</title>
<?php include("up2.php"); ?>
            <p class="lead text-resize">- <strong>Tchat Provence-Alpes-Côte-d'Azur</strong> -<br>Rejoindre les <strong><font color="#e6e6e6"><?php echo "$users" ;?></font></strong> t'chatteurs<br><strong><font color="#e6e6e6">Rencontre gratuite</font></strong> & <strong><font color="#e6e6e6">sans inscription</font></strong></p>
<?php include("up3.php"); ?>
<h1 class="section-title">Tchat Provence-Alpes-Côte-d'Azur sans inscription</h1>
<h2 class="section-title">Rencontre Provence-Alpes-Côte-d'Azur</h2>
<?php include("up4.php"); ?>
	        <br>
