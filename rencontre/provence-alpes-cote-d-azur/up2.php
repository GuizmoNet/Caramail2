  ...
  <meta name="description" content="Tchat gratuit Provence-Alpes-Côte-d'Azur - Rencontre et chat sans inscription. Discutez en direct et faites des rencontres gratuitement.">
  ...
  <meta property="og:title" content="Tchat gratuit Provence-Alpes-Côte-d'Azur - Rencontre sans inscription" />
  <meta property="og:url" content="https://chat-caramail.fr/rencontre/provence-alpes-cote-d-azur/"/>
  ...
  <?php $url = "https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; $url = strtok($url, '?'); $url = str_replace('/index.php', '', $url); $url = preg_replace('#(?<!:)//+#', '/', $url); echo '<link rel="canonical" href="' . $url . '">';  ?>
...
<div id="header">
    ...
    <div class="four columns pull-five">
      <div id="logo">Chat gratuit et site de rencontre gratuit
