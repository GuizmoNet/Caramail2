<?php include("up.php"); ?>
<title>Tchat gratuit Haute-Vienne - Rencontre Haute-Vienne</title>
<?php include("up2.php"); ?>
            <p class="lead text-resize">- <strong>Tchat Haute-Vienne</strong> -<br>Rejoindre les <strong><font color="#e6e6e6"><?php echo "$users" ;?></font></strong> t'chatteurs<br><strong><font color="#e6e6e6">Rencontre gratuite</font></strong> & <strong><font color="#e6e6e6">sans inscription</font></strong></p>
<?php include("up3.php"); ?>
<h1 class="section-title">Tchat Haute-Vienne sans inscription</h1>
<h2 class="section-title">Rencontre Haute-Vienne</h2>
<?php include("up4.php"); ?>
	        <br>
